...
describe("AiPlayer", function() {
  ...
  describe("other player", function() {
    it("returns the first piece that isn't the current player", function() {
      var nextPlayer = AiPlayer.nextPlayer("X", ["X", "O"]);

      expect(nextPlayer).toEqual("O");
    });

    it("returns the first piece that isn't the current player", function() {
      var nextPlayer = AiPlayer.nextPlayer("X", ["O", 1, 2, 3, 4, "Y", "X"]);
  ...
  describe("score board", function() {
    it("scores an empty board as 0", function() {
      ...
      expect(AiPlayer.scoreBoard(emptyBoard, true)).toEqual(0);
    });
  ...
  describe("minimax", function() {
    ...
    it("scores a board that will at best win as a 10", function() {
      var depth = 5;
    ...
    it("scores a board that will certainly lose as a -10", function() {
      var board = [0, "O", "O", 0, 0, 0, 0, 0, 0];
  ...
  describe("move using minimax", function() {
    var playerPieces = ["X", "O"];
